...
<head>
    ...
    <title>PAYTPV</title>
    <style type="text/css">
        <!--Estos estilos generales dentro del head, no pueden modificarse en el panel de control, contacte con PAYTPV-->
...
<div style="{SE CONFIGURA DESDE PANEL DE CONTROL}">
    ...
    <div>
        ...
        <div style="width:70%;">
            ...
            <div style="width:14%;"><img src="https://www.paytpv.com/gateway/img/cvv2.png" alt="CVC2" width="34" height="21" title="CVC2" style="margin-top:6px; margin-left:5px; float:left;" /></div>
            <div style="width:70%;"><span style="{SE CONFIGURA DESDE PANEL DE CONTROL}">(3 últimos dígitos)</span></div>
        </div>
    </div>

    <!-- Si el iframe se configura para incluir captcha -->
    <div>
        <div style="width:28%;"><span style="{SE CONFIGURA DESDE PANEL DE CONTROL}">Texto de la imagen:</span></div>
        <div style="width: 2%;"> </div>
        <div style="width:70%;">
            <input type="text" style="width:20% !important;{SE CONFIGURA DESDE PANEL DE CONTROL}" maxlength="5" id="checkimg" name="checkimg" value="" onClick="this.value='';" /><img src="https://www.paytpv.com/scripts/creadg4.php?id=1" alt="G3" width="78" height="26" title="G3" style="margin-top:6px; margin-left:5px; float:left;"  id="mybigsecret" /><img src="https://www.paytpv.com/img/recover.png" width="30" height="26" onclick="refreshmysecret();" alt="Haz click para refrescar la imagen" style="margin-top:6px; float:left; cursor:pointer;" title="Haz click para refrescar la imagen" />
        </div>
    </div>
    <!-- Si el iframe se configura para incluir captcha. Fin -->

    <div>
        <img src="https://www.paytpv.com/img/clockpayblue.gif" alt="Espere" width="41" height="30" id="clockwait" style="display:none; margin-top:5px;" />
